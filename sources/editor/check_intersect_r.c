...
/*   Updated: 2019/12/06 11:29:29 by eharrag-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "editor.h"

int		check_condition_r(t_sdl *sdl, t_sector *sector, int count)
{
...
void	find_intersection_r(t_sector *sector, int i, int x2, int y2)
{
...
int		check_intersect_r(t_sdl *sdl, t_sector *head, int x2, int y2)
{
	int		i;
	int		count;
